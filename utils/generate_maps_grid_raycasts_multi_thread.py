    ...
    for o in tqdm.tqdm(range(orn_slice)):
        ...
        for col in range(colors.shape[0]):
            for row in range(colors.shape[1]):
                ...
                depth_val_m, prediction_class, _, _ = ray_cast(occ_semantic, pos, theta, dist_max= 15 * 100, min_dist=5, cast_type=3) #close doors
...
def process_scene(scene, base_dir, desdf_dir):
    ...
    try:
        ...
        np.save(os.path.join(scene_dir, "desdf_closed_doors.npy"), desdf)
...
if __name__ == "__main__":
    ...
    # #Zind
    # yaml_path = '/datadrive2/CRM.AI.Research/TeamFolders/Email/repo_yuval/FloorPlan/Semantic_Floor_plan_localization/data/zind/fixed_fp_data_set/split.yaml'
    # base_dir = '/datadrive2/CRM.AI.Research/TeamFolders/Email/repo_yuval/FloorPlan/Semantic_Floor_plan_localization/data/zind/fixed_fp_data_set'
    # desdf_dir = '/datadrive2/CRM.AI.Research/TeamFolders/Email/repo_yuval/FloorPlan/Semantic_Floor_plan_localization/data/zind/desdf_80_fov_fixed_fp'

    # #S3D
    yaml_path = '/home/yuvalg/projects/Semantic_Floor_plan_localization/data/structured3d_perspective/test_data_set_full/split.yaml'
    base_dir = '/home/yuvalg/projects/Semantic_Floor_plan_localization/data/structured3d_perspective/test_data_set_full'
    desdf_dir = '/home/yuvalg/projects/Semantic_Floor_plan_localization/data/structured3d/desdf'
