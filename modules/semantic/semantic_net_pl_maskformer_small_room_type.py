...
from .semantic_net_maskformer_small_room_type import semantic_net
from .resnet_semantic_and_room_type import semantic_net_resnet
from .resnet_semantic_and_room_type_with_cls import semantic_net_resnet_with_cls
import torch
class semantic_net_pl_maskformer_small_room_type(pl.LightningModule):
    """
    ...
    def __init__(
        ...
        # The actual model
        if semantic_net_type == 'resnet':
            self.model = semantic_net_resnet(
                num_ray_classes=self.num_ray_classes,
                num_room_types=self.num_room_types
            )
        elif semantic_net_type == 'resnet_cls':
            self.model = semantic_net_resnet_with_cls(
                num_ray_classes=self.num_ray_classes,
                num_room_types=self.num_room_types
            )
